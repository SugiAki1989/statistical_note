...
第5章で使用されているコードや演習問題の解答は、[出版社のサイト](https://www.asakura.co.jp/user_data/contents/12212/1.zip)のファイルから確認できるが、演習問題の解答に使用するRのコードは確認できないので、私が記載している解答が正しいかはわからない。
...
# fit<-hmc(N=10000,ini=c(168,49),E=lognorm,D=Dlognorm,L=100,epsi=0.01)
# z<-fit$z
# r<-fit$rr
# print(fit$ac); #採用率
# zzz<-c(1001:10000)
